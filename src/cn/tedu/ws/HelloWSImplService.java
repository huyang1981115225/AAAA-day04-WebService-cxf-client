 ...
 * 2019-01-14T14:08:34.940+08:00
 * Generated source version: 2.5.9
 * 
 */
@WebServiceClient(name = "HelloWSImplService", 
                  wsdlLocation = "file:/E:/eclipse-workspace/AAAA-day04-WebService-cxf-client/cxftest.wsdl",
                  targetNamespace = "http://ws.tedu.cn/") 
public class HelloWSImplService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://ws.tedu.cn/", "HelloWSImplService");
    public final static QName HelloWSImplPort = new QName("http://ws.tedu.cn/", "HelloWSImplPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/E:/eclipse-workspace/AAAA-day04-WebService-cxf-client/cxftest.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(HelloWSImplService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/E:/eclipse-workspace/AAAA-day04-WebService-cxf-client/cxftest.wsdl");
        }
        WSDL_LOCATION = url;
    }
